...
const Sidebar = () => {
  ...
  const adminLinks = [
    ...
    { to: '/admin/scanner', label: 'QR Check-in', icon: ScanLine },
  ];
  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 h-screen hidden md:flex flex-col sticky top-0">
      ...
      <div className="flex-1 py-4 flex flex-col gap-1 px-3">
        <div className="mb-2 px-3 py-1 text-xs font-semibold text-gray-400 uppercase tracking-wider">Main Menu</div>
        {links.map((link) => {
